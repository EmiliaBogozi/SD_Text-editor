                ...
                case 'g' :
                    ...
                    if(c == 'l'){
                        ...
                        if(nr_linie == 1){
                            ...
                            auxh->prev = NULL;
                            lista = lista->prev;
                            ///facem sa fie enter la inceput si dupa il stergem
...
//                                cursor = lista;
 ...
 //           printf("Numar linii: %d\nLinie cursor:%d\nPoz cursor%d\n", k,lin,poz);
            ...
            //show(lista);
           // if(cursor->next != NULL)
           //     printf("%c%c", cursor->c, cursor->next->c);
            //if(cursor->next == NULL)
             //   printf("YUP");
...
///adauga!!!!!!!!!
///delete simplu
///particularizam pt gl 1(sa fie inainte de prima chestie)
///cursor->prev->c = '\n'
///cursor = cursor->prev;
